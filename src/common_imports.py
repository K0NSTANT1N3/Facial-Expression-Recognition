  ...
  "cells": [
    {
      ...
      "source": [
        ...
        "!git clone {repo_url}\n",
        "\n",
        "# Move into your repository folder to start working\n",
        "os.chdir(REPO_NAME)\n",
        "!ls -la"
      ],
      "metadata": {
        ...
        "id": "Alp_trKMYDOQ",
        "outputId": "36b36d51-948c-45c4-fee8-60bc5bf7bb25"
      },
      "id": "Alp_trKMYDOQ",
      "execution_count": 5,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Receiving objects: 100% (25/25), 6.50 KiB | 6.50 MiB/s, done.\n",
            "Resolving deltas: 100% (5/5), done.\n",
            "remote: Total 25 (delta 5), reused 11 (delta 2), pack-reused 0 (from 0)\u001b[K\n",
            "total 36\n",
            "drwxr-xr-x 5 root root 4096 Jun 14 18:24 .\n",
            "drwxr-xr-x 7 root root 4096 Jun 14 18:24 ..\n",
            "drwxr-xr-x 8 root root 4096 Jun 14 18:24 .git\n",
            "-rw-r--r-- 1 root root 4628 Jun 14 18:24 .gitignore\n",
            "-rw-r--r-- 1 root root 1078 Jun 14 18:24 LICENSE\n",
            "drwxr-xr-x 2 root root 4096 Jun 14 18:24 notebooks\n",
            "-rw-r--r-- 1 root root   31 Jun 14 18:24 README.md\n",
            "drwxr-xr-x 2 root root 4096 Jun 14 18:24 src\n"
          ]
        }
      ]
    },
    {
      ...
      "source": [
        "import os\n",
        "from google.colab import userdata\n",
        "# Set your Kaggle API token (Paste the exact token you copied)\n",
        "os.environ['KAGGLE_API_TOKEN'] = userdata.get('KAGGLE_API_TOKEN')\n",
        "\n",
        "# 1. Download the FER2013 competition dataset\n",
      ...
      "metadata": {
        ...
        "id": "tLmgN6zrYDUA",
        "outputId": "f27ce6e1-1f7c-4d2c-d564-61bde87d8c98"
      },
      "id": "tLmgN6zrYDUA",
      "execution_count": 4,
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "Downloading challenges-in-representation-learning-facial-expression-recognition-challenge.zip to /content/Facial-Expression-Recognition\n",
            "100% 285M/285M [00:05<00:00, 54.2MB/s]\n",
            "\n",
    ...
    },
    {
      ...
      "source": [
        "\n",
        "df = pd.read_csv(\"/content/fer2013_data/train.csv\")\n",
        "df.head()"
      ],
      "metadata": {
        "id": "kkt8MlBbYwPE",
        "outputId": "f7e85b94-eaf8-4451-d553-434d4dc2df6a",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 206
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-7efa76ca-9134-45e2-9c1c-76dfc8b9bfd0\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              ...
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-7efa76ca-9134-45e2-9c1c-76dfc8b9bfd0')\"\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-7efa76ca-9134-45e2-9c1c-76dfc8b9bfd0 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-7efa76ca-9134-45e2-9c1c-76dfc8b9bfd0');\n",
              "        const dataTable =\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "Q5YFVvFze0db",
        "outputId": "4233a31f-d7fe-4156-e808-da6ba824ec32",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 254
        }
      ...
      "outputs": [
        {
          ...
          "traceback": [
            ...
            "\u001b[0;32m/tmp/ipykernel_7589/530442607.py\u001b[0m in \u001b[0;36m<cell line: 0>\u001b[0;34m()\u001b[0m\n\u001b[0;32m----> 1\u001b[0;31m train_df, val_df = train_test_split(\n\u001b[0m\u001b[1;32m      2\u001b[0m     \u001b[0mdf\u001b[0m\u001b[0;34m,\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      3\u001b[0m     \u001b[0mtest_size\u001b[0m\u001b[0;34m=\u001b[0m\u001b[0;36m0.2\u001b[0m\u001b[0;34m,\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      4\u001b[0m     \u001b[0mrandom_state\u001b[0m\u001b[0;34m=\u001b[0m\u001b[0;36m67\u001b[0m\u001b[0;34m,\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      5\u001b[0m     \u001b[0mstratify\u001b[0m\u001b[0;34m=\u001b[0m\u001b[0mdf\u001b[0m\u001b[0;34m[\u001b[0m\u001b[0;34m\"emotion\"\u001b[0m\u001b[0;34m]\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n",
